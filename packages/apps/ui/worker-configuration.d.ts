/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 960a7c99e3b39cadcd4f85f7c32d33da)
// Runtime types generated with workerd@1.20260521.1 2026-05-24 nodejs_compat
interface __BaseEnv_Env {
	NODE_ENV: 'production';
	PUBLIC_COORDINATOR_BFF_BASE: string;
	PUBLIC_MANDATE_PRIVY_APP_ID: string;
	PUBLIC_MANDATE_PRIVY_CLIENT_ID: string;
	PUBLIC_DEFAULT_CHAIN_ID: string;
