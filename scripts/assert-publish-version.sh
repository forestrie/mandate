#!/usr/bin/env bash
# assert-publish-version.sh — shared publish-workflow version guard, ported
# from canopy scripts/assert-publish-version.sh (FOR-365 C3; here FOR-360 /
# FOR-361).
#
...
#   e.g. assert-publish-version.sh packages/publish/mandate-register mandate-register
#
