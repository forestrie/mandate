...
- **D1 (canopy):** genesis accepts any 20-byte bootstrapKey; the D8 attestation
  binds the *request*, nothing binds the *genesis key* to it, and same-R retry
