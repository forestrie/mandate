/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 230154cf5415c1d576b428082c805adc)
// Runtime types generated with workerd@1.20260521.1 2026-05-24 nodejs_compat
interface __BaseEnv_Env {
	NODE_ENV: 'production';
	COORDINATOR_AUTH_MODE: 'app_token_bff';
	COORDINATOR_UPSTREAM_URL: 'https://coordinator-dev.forestrie.dev';
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, 'NODE_ENV' | 'COORDINATOR_AUTH_MODE' | 'COORDINATOR_UPSTREAM_URL'>
	> {}
}
